...
export default function StudyDashboard() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0a0f1e", color: "#e2e8f0", fontFamily: "'Noto Sans KR', sans-serif", paddingBottom: 80 }}>
      ...
      <div style={{ display: "flex", background: "#111827", borderBottom: "1px solid #1e293b", position: "sticky", top: 0, zIndex: 10 }}>
        {[["current", "📋", "주차입력"], ["heatmap", "🗓", "현황판"], ["history", "📊", "기록"], ["members", "👥", "멤버"]].map(([key, icon, label]) => (
          <button key={key} onClick={() => setTab(key)}
            style={{ flex: 1, padding: "11px 2px", background: "none", border: "none", borderBottom: tab === key ? "2px solid #38bdf8" : "2px solid transparent", color: tab === key ? "#38bdf8" : "#475569", fontWeight: tab === key ? 700 : 400, fontSize: 11, cursor: "pointer", transition: "all 0.2s", fontFamily: "inherit" }}>
